...
public sealed class YoutubeSearchViewModel : ReactiveObject
{
    ...
    public YoutubeSearchViewModel()
    {
        ...
        _searchService = new YoutubeSearchService(); // Program.ServiceProvider.GetService<YoutubeSearchService>() ?? throw new Exception( "Failed to get Youtube Search Service!" );
